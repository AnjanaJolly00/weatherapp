class AirPollutionResponse {
  Coord? coord;
  List<PollutionList>? pollutionList;

  AirPollutionResponse({this.coord, this.pollutionList});
  ...
  AirPollutionResponse.fromJson(Map<String, dynamic> json) {
    ...
    if (json['list'] != null) {
      ...
      json['list'].forEach((v) {
        pollutionList!.add(PollutionList.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (pollutionList != null) {
      data['list'] = pollutionList!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class PollutionList {
  ...
  PollutionList({this.main, this.components, this.dt});
